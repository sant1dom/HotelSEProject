                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group has-text-centered">
                                            <div class="autocomplete" style="width: 100%">
                                                ...
                                                <input class="form-control @error('type') is-invalid @enderror"
                                                       id="type" type="text" name="type" placeholder="Ex.: Luxury" value="{{ old('type') }}"/>
                                            </div>
                                            <div class="row my-3">
                                                <div class="col-sm">
                                                    ...
                                                    <input class="form-control @error('price') is-invalid @enderror"
                                                           id="price"
                                                           name="price" type="number" min="0" placeholder="Ex.: 50" value="{{ old('price') }}"/>
                                                </div>
                                                <div class="col-sm">
                                                    ...
                                                    <input class="form-control @error('capacity') is-invalid @enderror"
                                                           ...
                                                           placeholder="Ex.: 4" value="{{ old('capacity') }}"/>
                                                </div>
                                                <div class="col-sm">
                                                    ...
                                                    <input class="form-control @error('numroom') is-invalid @enderror"
                                                           ...
                                                           placeholder="Ex: D110" value="{{ old('numroom') }}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm h-75">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                                  ...
                                                  style="resize: none"
                                                  placeholder="Put a description of the room here...">{{ old('description') }}</textarea>
                                    </div>
                                </div>
